...
namespace Ex03.GarageLogic
{
    ...
    public abstract class Vehicle
    {
        ...
        public abstract object FirstDifferentProperty { get; set; }
        public abstract object SecondDifferentProperty { get; set; }
        ...
        public override sealed string ToString()
        {
            ...
            builder.AppendFormat(
                ...
                m_LicenseNumber, m_ModelName, m_WheelCollection.ToString(), this.GetAttributes(), m_Engine.ToString(),
                m_RemainingEnergyPercent.ToString());
